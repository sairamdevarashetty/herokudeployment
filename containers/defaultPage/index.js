...
import { getDefaultPageModule } from './dynamicStore';
...
class DefaultPageContainer extends React.Component {
  ...
  render() {
    ...
    return (
      <DynamicModuleLoader modules={[getDefaultPageModule()]}>
        <div id="page-top">
          <Head>
          <title>Home</title>
          ...
          <FeaturedCategories data={{header: 'What to do? Get inspiration'}} length={3} />
...
export default connect(
  mapStateToProps,
  mapDispatchToProps
)(withRouter(DefaultPageContainer))